...
def build_rooms() -> Dict[str, Any]:
    ...
    return {
        ...
        "templeLift": {
            ...
            "exits": {"west": "quarters", "east": "labs", "down": "excavation", "south": "hellGateAntechamber"},
            "hotspots": [
                ...
                {"id": "toAntechamber", "name": "Threshold Passage", "rect": {"l": 36, "t": 72, "w": 28, "h": 14}, "kind": "exit", "data": {"dir": "south"}},
            ],
        },
        "excavationHatch": {
            "id": "excavationHatch",
        ...
        "excavation": {
            ...
            "exits": {"south": "excavationHatch", "north": "hellGateAntechamber", "up": "templeLift"},
            "hotspots": [
                {"id": "toHatch", "name": "Hatch", "rect": {"l": 10, "t": 34, "w": 18, "h": 28}, "kind": "exit", "data": {"dir": "south"}},
                {"id": "toLift", "name": "Lift Shaft", "rect": {"l": 26, "t": 52, "w": 16, "h": 18}, "kind": "exit", "data": {"dir": "up"}},
        ...
        "hellGateAntechamber": {
            ...
            "exits": {"south": "excavation", "north": "hellGateChamber", "up": "templeLift"},
            ...
            "hotspots": [
                ...
                {"id": "toLift", "name": "Service Lift", "rect": {"l": 78, "t": 34, "w": 18, "h": 28}, "kind": "exit", "data": {"dir": "up"}},
